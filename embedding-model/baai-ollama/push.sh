...
IMAGE_NAME="ollama-baai-embedding"
IMAGE_TAG="1.0"
...
docker tag  ${IMAGE_NAME}:${IMAGE_TAG} ${DOCKER_REGISTRY}/${PROJECT_NAME}/${IMAGE_NAME}:${IMAGE_TAG}


# Docker 이미지 푸시
docker push ${DOCKER_REGISTRY}/${PROJECT_NAME}/${IMAGE_NAME}:${IMAGE_TAG}
