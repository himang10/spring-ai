...
import com.example.springai.service.CompressionQueryService;
...
@RestController
@RequestMapping("/chat")
public class CompressionQueryController {

    private final CompressionQueryService service;

    public CompressionQueryController(CompressionQueryService service) {
