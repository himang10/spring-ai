...
let isTyping = false;
let apiPath = '/chat/text-embedding'; // 기본 API 경로
...
async function handleSubmit(e) {
    ...
    try {
        ...
        // API별 파라미터 설정
        if (apiPath === '/chat/text-embedding' || apiPath === '/chat/search' || apiPath === '/chat/search-with-filter') {
            formData.append('question', message);
        } else if (apiPath === '/chat/delete-document') {
