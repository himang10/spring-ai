...
import com.example.springai.service.PostRetrievalService;
...
@RestController
@RequestMapping("/chat")
public class PostRetrievalController {

    private final PostRetrievalService service;

    public PostRetrievalController(PostRetrievalService service) {
