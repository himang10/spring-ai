...
public class OutputConverterController {
    ...
    public ResponseEntity<ActorsFilms> getSingleActorFilms(@RequestBody Map<String, String> request) {
        String question = request.getOrDefault("message", "Tom Hanks");
        ActorsFilms actorsFilms = beanOutputService.getSingleActorFilms(question);
    ...
    public ResponseEntity<List<ActorsFilms>> getMultipleActorsFilms(@RequestBody Map<String, String> request) {
        String question = request.getOrDefault("message", "Tom Hanks and Bill Murray");
        List<ActorsFilms> actorsFilmsList = beanOutputService.getMultipleActorsFilms(question);
    ...
    public ResponseEntity<Map<String, Object>> getMapResult(@RequestBody Map<String, String> request) {
        String question = request.getOrDefault("message", "an array of numbers from 1 to 9 under they key name 'numbers'");
        Map<String, Object> result = mapOutputService.getMapResult(question);
    ...
    public ResponseEntity<List<String>> getListResult(@RequestBody Map<String, String> request) {
        String question = request.getOrDefault("message", "ice cream flavors");
        List<String> flavors = listOutputService.getListResult(question);
