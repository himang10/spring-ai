...
let isTyping = false;
let apiPath = '/chat/bean'; // 기본 API 경로
...
function initializeEventListeners() {
    ...
    if (pathSelector) {
        ...
        const placeholderMap = {
            '/chat/bean': '톰 행크스에 대한 5개 영화 필로그래피를 생성하세요',
            '/chat/list-bean': '톰 행크스와 빌 머레이에 대한 5개 영화 필로그래피를 생성하세요',
            '/chat/map': '과일 이름과 맛 10종류를 리스트로 제공해줘',
            '/chat/list': '아이스크림 맛을 10가지 제시해줘'
        };
