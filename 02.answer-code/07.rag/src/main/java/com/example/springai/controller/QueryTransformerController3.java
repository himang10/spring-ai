...
import com.example.springai.service.QueryTransformerService3;
...
@RestController
@RequestMapping("/chat")
public class QueryTransformerController3 {

    private final QueryTransformerService3 service;

    public QueryTransformerController3(QueryTransformerService3 service) {
