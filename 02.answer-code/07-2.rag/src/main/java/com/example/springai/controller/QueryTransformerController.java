...
import com.example.springai.service.QueryTransformerService;
...
public class QueryTransformerController {
    ...
    private final QueryTransformerService service;

    public QueryTransformerController(QueryTransformerService service) {
