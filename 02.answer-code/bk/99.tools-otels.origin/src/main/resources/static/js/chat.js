...
let isTyping = false;
let apiPath = '/chat/date-time-tools'; // 기본 API 경로
...
function initializeEventListeners() {
    ...
    if (pathSelector) {
        ...
        const placeholderMap = {
            '/chat/date-time-tools': '10분뒤에 알람을 설정해줘',
            '/chat/weather-tools': '서울 날씨 어때?',
            '/chat/filesystem-tools': '이 질문을 파일로 저장해줘',
            '/chat/music-tools': '퀸의 보헤미안 랩소디 찾아줘'
        };
